...
static struct ch_list_t RTW_ChannelPlan5G[] = {
	...
	/* 57, RTW_RD_5G_ETSI22 */	CH_LIST_ENT(24, 36, 40, 44, 48, 52, 56, 60, 64, 100, 104, 108, 112, 116, 120, 124, 128, 132, 136, 140, 144, 149, 153, 157, 161),
	/* 58, RTW_RD_5G_ETSI23 */	CH_LIST_ENT(12, 36, 40, 44, 48, 52, 56, 60, 64, 149, 153, 157, 161),
	/* 59, RTW_RD_5G_ETSI24 */	CH_LIST_ENT(22, 36, 40, 44, 48, 52, 56, 60, 64, 100, 104, 108, 112, 116, 132, 136, 140, 144, 149, 153, 157, 161, 165),
	/* 60, RTW_RD_5G_ETSI25 */	CH_LIST_ENT(17, 36, 40, 44, 48, 52, 56, 60, 64, 132, 136, 140, 144, 149, 153, 157, 161, 165),
...
static RT_CHANNEL_PLAN_MAP	RTW_ChannelPlanMap[RTW_CHPLAN_MAX] = {
	...
	CHPLAN_ENT(RTW_RD_2G_ETSI1,		RTW_RD_5G_ETSI24,	TXPWR_LMT_ETSI),	/* 0x22, RTW_CHPLAN_ETSI1_ETSI23 */
	CHPLAN_ENT(RTW_RD_2G_FCC2,		RTW_RD_5G_FCC19,	TXPWR_LMT_FCC),		/* 0x23, RTW_CHPLAN_FCC2_FCC17 */
	...
	CHPLAN_ENT(RTW_RD_2G_ETSI1,		RTW_RD_5G_WORLD,	TXPWR_LMT_ETSI),	/* 0x27, LG Default CE, RTW_CHPLAN_LGE_DC0 */
	...
	/* REG */
	CHPLAN_ENT(RTW_RD_2G_ETSI1,		RTW_RD_5G_ETSI2,	TXPWR_LMT_ETSI),	/* 0x2a, RTW_CHPLAN_ETSI1_ETSI1 */
	...
	CHPLAN_ENT(RTW_RD_2G_WORLD1,		RTW_RD_5G_ETSI12,	TXPWR_LMT_ETSI),	/* 0x2d, RTW_CHPLAN_ETSI3_ETSI12 */
	/* JP */
	CHPLAN_ENT(RTW_RD_2G_MKK1,		RTW_RD_5G_MKK1,		TXPWR_LMT_MKK),		/* 0x2e, RTW_CHPLAN_MKK2_MKK1 */
	CHPLAN_ENT(RTW_RD_2G_ETSI1,		RTW_RD_5G_ETSI2,	TXPWR_LMT_ETSI),	/* 0x2f, RTW_CHPLAN_ETSI1_ETSI2 */
	CHPLAN_ENT(RTW_RD_2G_ETSI1,		RTW_RD_5G_ETSI24,	TXPWR_LMT_ETSI),	/* 0x30, RTW_CHPLAN_ETSI1_ETSI24 */
	CHPLAN_ENT(RTW_RD_2G_ETSI1,		RTW_RD_5G_ETSI6,	TXPWR_LMT_ETSI),	/* 0x31, RTW_CHPLAN_ETSI1_ETSI6 */
	CHPLAN_ENT(RTW_RD_2G_FCC2,		RTW_RD_5G_FCC15,	TXPWR_LMT_FCC),		/* 0x32, RTW_CHPLAN_FCC2_FCC18 */
	/* RMY */
	CHPLAN_ENT(RTW_RD_2G_ETSI1,		RTW_RD_5G_ETSI23,	TXPWR_LMT_ETSI),	/* 0x33, RTW_CHPLAN_ETSI1_ETSI22 */
	...
	/* RSA */
	CHPLAN_ENT(RTW_RD_2G_ETSI1,		RTW_RD_5G_ETSI22,	TXPWR_LMT_ETSI),	/* 0x36, RTW_CHPLAN_ETSI1_ETSI21 */
	CHPLAN_ENT(RTW_RD_2G_FCC1,		RTW_RD_5G_FCC20,	TXPWR_LMT_FCC),		/* 0x37, RTW_CHPLAN_FCC1_FCC18 */
...
void init_mlme_default_rate_set(_adapter *padapter)
{
	...
	unsigned char	supported_mcs_set[16] = {0xff, 0xff, 0xff, 0x00, 0x01, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0};
...
unsigned int OnProbeReq(_adapter *padapter, union recv_frame *precv_frame)
{
	...
	if ((pwdinfo->driver_interface == DRIVER_CFG80211)
		...
		return _SUCCESS;
			   ...
			   && rtw_p2p_chk_state(pwdinfo, P2P_STATE_GONEGO_OK)) {
		rtw_cfg80211_rx_probe_request(padapter, precv_frame);
		return _SUCCESS;
	} else if ((pwdinfo->driver_interface == DRIVER_CFG80211)
...
#endif /* CONFIG_P2P */
			{
				/* in order to find hidden AP fastly */
				int i;
...
operation_by_state:
	...
	case SCAN_DISABLE:
		...
		*/
		...
		if (rtw_mi_busy_traffic_check(padapter, _FALSE))
			mlmeext_assign_scan_backop_flags_sta(pmlmeext,
				SS_BACKOP_EN | SS_BACKOP_PS_ANNC | SS_BACKOP_TX_RESUME);
		else
			mlmeext_assign_scan_backop_flags_sta(pmlmeext,
				SS_BACKOP_PS_ANNC | SS_BACKOP_TX_RESUME);
#endif /* LGE_PRIVATE */
	...
	case SCAN_PROCESS: {
		...
		if (IS_ACS_ENABLE(padapter) && rtw_is_acs_st_valid(padapter))
			...
			scan_ms = ss->scan_ch_ms;
		#else
		if (scan_type == SCAN_ACTIVE) scan_ms = ss->scan_ch_ms;
		else scan_ms = SURVEY_P_TO;
		#endif /*CONFIG_RTW_ACS*/
#endif
