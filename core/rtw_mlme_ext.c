...
static RT_CHANNEL_PLAN_MAP	RTW_ChannelPlanMap[] = {
	...
	CHPLAN_ENT(RTW_RD_2G_ETSI1,		RTW_RD_5G_ETSI7,	TXPWR_LMT_ETSI),	/* 0x27, LG Default CE, RTW_CHPLAN_LGE_DC0 */
	CHPLAN_ENT(RTW_RD_2G_FCC2,		RTW_RD_5G_FCC3,		TXPWR_LMT_FCC),		/* 0x28, LG Default FCC, RTW_CHPLAN_LGE_DC1 */
