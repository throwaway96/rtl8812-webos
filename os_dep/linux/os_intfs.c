...
module_param(rtw_mcc_enable_runtime_duration, int, 0644);
...
#ifdef CONFIG_USB_HCI
		/*disable usb phy*/
		rtw_write8(padapter, REG_SYS_FUNC_EN, rtw_read8(padapter, REG_SYS_FUNC_EN) & 0xfb);
