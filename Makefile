...
EXTRA_CFLAGS += -DCOUNTRY_DEFAULT_VER=3
EXTRA_CFLAGS += -DCOUNTRY_DEFAULT_CCODE=10
EXTRA_CFLAGS += -DLGE_LOAD_COUNTRIES=1
EXTRA_CFLAGS += -DDBG_RX_DFRAME_RAW_DATA
EXTRA_CFLAGS += -DCONFIG_FW_OFFLOAD_PARAM_INIT
...
ifeq ($(CONFIG_PLATFORM_ARM_LGE), y)
EXTRA_CFLAGS += -DCONFIG_LITTLE_ENDIAN
EXTRA_CFLAGS += -DCONFIG_IOCTL_CFG80211 -DRTW_USE_CFG80211_STA_EVENT
EXTRA_CFLAGS += -DCONFIG_CONCURRENT_MODE
EXTRA_CFLAGS += -DRTW_P2P_GROUP_INTERFACE=1
