...
#ifdef LGE_PRIVATE
	LGE_PRIVATE_CMD_SET_MCHAN_SCHED_MODE,
	LGE_PRIVATE_CMD_GET_CS_INFO,
	LGE_PRIVATE_CMD_SET_WOWL,
	LGE_PRIVATE_CMD_WOWL_ACTIVATE,
	LGE_PRIVATE_CMD_IDLE_MODE,
	LGE_PRIVATE_CMD_SET_ABNORMAL,
#endif /* LGE_PRIVATE */
