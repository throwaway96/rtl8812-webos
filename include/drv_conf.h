...
#if defined(CONFIG_MCC_MODE) && (defined(CONFIG_TDLS) && defined(CONFIG_TDLS_CH_SW))

	#error "Disable TDLS CH SW before enable MCC MODE\n"
...
#ifdef LGE_PRIVATE
/* LGE Only, set STA AMPDU Size */
#define CONFIG_RTW_RX_AMPDU_SZ_LIMIT_1SS {0x20, 0x20, 0x20, 0x20}
#define CONFIG_RTW_RX_AMPDU_SZ_LIMIT_2SS {0x20, 0x20, 0x20, 0x20}
/* LGE Only, set P2P AMPDU Size */
#define CONFIG_RTW_P2P_RX_AMPDU_SZ_LIMIT_1SS {0x10, 0x20, 0x20, 0x20}
#define CONFIG_RTW_P2P_RX_AMPDU_SZ_LIMIT_2SS {0x10, 0x20, 0x20, 0x20}
#endif /* LGE_PRIVATE */
