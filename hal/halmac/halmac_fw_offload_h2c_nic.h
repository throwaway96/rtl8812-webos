...
#define PHYDM_INFO_GET_REF_TYPE(_pH2C) LE_BITS_TO_4BYTE(_pH2C + 0X08, 0, 8)
#define PHYDM_INFO_SET_REF_TYPE(_pH2C, __Value) SET_BITS_TO_LE_4BYTE(_pH2C + 0X08, 0, 8, __Value)
#define PHYDM_INFO_GET_RF_TYPE(_pH2C) LE_BITS_TO_4BYTE(_pH2C + 0X08, 8, 8)
#define PHYDM_INFO_SET_RF_TYPE(_pH2C, __Value) SET_BITS_TO_LE_4BYTE(_pH2C + 0X08, 8, 8, __Value)
#define PHYDM_INFO_GET_CUT_VER(_pH2C) LE_BITS_TO_4BYTE(_pH2C + 0X08, 16, 8)
#define PHYDM_INFO_SET_CUT_VER(_pH2C, __Value) SET_BITS_TO_LE_4BYTE(_pH2C + 0X08, 16, 8, __Value)
#define PHYDM_INFO_GET_RX_ANT_STATUS(_pH2C) LE_BITS_TO_4BYTE(_pH2C + 0X08, 24, 4)
#define PHYDM_INFO_SET_RX_ANT_STATUS(_pH2C, __Value) SET_BITS_TO_LE_4BYTE(_pH2C + 0X08, 24, 4, __Value)
#define PHYDM_INFO_GET_TX_ANT_STATUS(_pH2C) LE_BITS_TO_4BYTE(_pH2C + 0X08, 28, 4)
#define PHYDM_INFO_SET_TX_ANT_STATUS(_pH2C, __Value) SET_BITS_TO_LE_4BYTE(_pH2C + 0X08, 28, 4, __Value)
#endif
