...
static int _send_general_info(struct dvobj_priv *d)
{
	...
	switch (info.rf_type) {
	case HALMAC_RF_1T2R:
		info.tx_ant_status = ODM_RF_A;
		info.rx_ant_status = ODM_RF_A | ODM_RF_B;
		break;
	case HALMAC_RF_2T2R:
		info.tx_ant_status = ODM_RF_A | ODM_RF_B;
		info.rx_ant_status = ODM_RF_A | ODM_RF_B;
		break;
	default:
	case HALMAC_RF_1T1R:
		info.tx_ant_status = ODM_RF_A;
		info.rx_ant_status = ODM_RF_A;
		break;
	}
...
int rtw_halmac_send_general_info(struct dvobj_priv *d)
{
	return _send_general_info(d);
}
